                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        if ($result->rowCount() > 0) {
                                                            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                                                ...
                                                                echo "<td><a href='update_mhs_view.php?nim=" . $row["nim"] . "'>Edit</a> | <a href='delete_mhs_view.php?nim=" . $row["nim"] . "'>Hapus</a></td>"; // Tautan untuk mengedit dan menghapus
                                                                echo "</tr>";
                                                            }
                                                        } else {
