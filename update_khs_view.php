                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="auth-content my-auto">
                                <form class="mt-5 pt-2" method="post" action="update_khs_process.php">
                                    <?php
                                    // Ambil ID dari URL menggunakan GET method, contoh: ?id=123
                                    $id = isset($_GET['id']) ? $_GET['id'] : '';

                                    // Jika ID ditemukan, tampilkan di input hidden
                                    if (!empty($id)) {
                                    ...
                                    <div class="mb-24">
                                        ...
                                        <input type="number" class="form-control" id="nilai" name="nilai" step="0.1" />
                                    </div>
