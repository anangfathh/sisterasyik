                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <div id="task-profile_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-7 d-flex justify-content-start gap-3">
                                            <!-- Tombol untuk menambah log -->
                                            <div class="dataTables_paginate paging_simple_numbers" id="task-profile_paginate">
                                                <a href="create_log_view.php">
                                                    <button class="btn btn-primary">Add Log</button>
                                                </a>
                                            </div>
                                            <!-- Tombol untuk mengekspor log ke XML -->
                                            <div class="dataTables_paginate paging_simple_numbers" id="task-profile_paginate">
                                                <a href="export_log_to_xml.php" target="_blank">
                                                    <button class="btn btn-primary">Export Log to XML</button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                  <tr class="odd">
                                                      ...
                                                      // Perbaikan query: tambahkan tanda kutip penutup dan tambahkan kolom 'id'
                                                      ...
                                                      if ($result->rowCount() > 0) {
                                                          while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                                              ...
                                                              // Perbaiki penempatan link hapus
                                                              echo "<td><a href='delete_log_view.php?id=" . $row["id"] . "'>Hapus</a></td>";
                                                              echo "</tr>";
                                                          }
                                                      } else {
                                                          echo "<tr><td colspan='8'>Tidak ada data log.</td></tr>";  // Sesuaikan jumlah kolom (8 kolom)
                                                      }
                                                      ?>
                                                  </tr>
                                              </tbody>
