                                                    ...
                                                    <tr class="odd">
                                                        ...
                                                        if ($result->rowCount() > 0) {
                                                            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                                                ...
                                                                echo "<td><a href='update_mk_view.php?kode=" . $row["kode_mk"] . "'>Edit</a> | <a href='delete_mk_view.php?kode=" . $row["kode_mk"] . "'>Hapus</a></td>"; // Tautan untuk mengedit dan menghapus
                                                                echo "</tr>";
                                                            }
                                                        } else {
