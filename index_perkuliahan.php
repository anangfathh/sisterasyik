                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    <tr class="odd">
                                                        ...
                                                        $sql = "SELECT m.kode_mk as `kode_mk`, mhs.nim as `nim`, m.nama as `nama`, mhs.nama as `nama_mhs`, nilai, id  FROM perkuliahan p
                                                        join matkul m on m.kode_mk = p.kode_mk
                                                        join mahasiswa mhs on mhs.nim = p.nim";
                                                        ...
                                                        if ($result->rowCount() > 0) {
                                                            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                                                ...
                                                                echo "<td><a href='update_khs_view.php?id=" . $row["id"] . "'>Edit</a> | <a href='delete_khs_view.php?id=" . $row["id"] . "'>Hapus</a></td>";
                                                                echo "</tr>";
                                                            }
                                                        } else {
                                                            echo "<tr><td colspan='5'>Tidak ada data khs.</td></tr>";
                                                        }
