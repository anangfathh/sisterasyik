                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="auth-content my-auto">
                                <form class="mt-5 pt-2" method="post" action="create_mk_process.php">
                                    <div class="mb-24">
                                        <label class="form-label mb-14">Kode Mata Kuliah</label>
                                        <input type="text" class="form-control" id="kode_mk" name="kode_mk" />
                                    </div>
                                    <div class="mb-24">
                                        <label class="form-label mb-14">Nama Mata Kuliah</label>
