                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-body">
                            ...
                            <form class="mt-5 pt-2" method="post" action="create_log_process.php">
                                <div class="mb-24">
                                    <label class="form-label mb-14">LogDB</label>
                                    <textarea class="form-control" id="log" name="log" rows="5" placeholder="Masukkan beberapa log, pisahkan dengan baris baru"></textarea>
                                </div>
                                <div class="mb-3">
                                    <button class="btn bg-primary color-white w-100 waves-effect waves-light fs-18 font-w500" type="submit">
                                        Submit
                                    </button>
                                </div>
                            </form>
